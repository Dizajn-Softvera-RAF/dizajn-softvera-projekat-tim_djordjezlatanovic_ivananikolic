...
public class NewProjectAction extends AbstractClassyAction{
    public NewProjectAction() {
        ...
        putValue(SMALL_ICON, loadIcon("/images/more.png"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(selected instanceof ClassyTreeItem){
            ...
            ApplicationFramework.getInstance().getMessageGenerator().generateMessage("Morate selektovati cvor u stablu", MessageType.WARNING, LocalDateTime.now());
    }
